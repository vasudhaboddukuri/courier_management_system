...
<h2>Add Couriers</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="client.php#home" class="slider_nav_btn home_btn" >	home</a></h2>
                   ...
                   <tr>
                      ...
                      <td width="339">
                        <input name="sname"  maxlength="100" size="40" type="TEXT"> </td>
                          ...
                          <tr>
                            <td class="TrackMediumBlue" align="right">Enforced Condition  :</td>
                            <td>&nbsp;</td>
                            <td><select id="mode" name="mode">
                                <option value="Speed_post" selected="selected">Speed_post</option>
                                <option value="Care">Handle_with_care</option>
