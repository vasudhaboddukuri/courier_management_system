...
<br>
<form>
<input type="button" value="Track Courier"  onclick="window.location.href='#testimonial' " />
</form>
<br>
<br>
<form>
...
<br>
<form>
<input type="button" value="Add Courier Details"  onclick="window.location.href='addc.php' " />
</form>
<br>
<br>
<form>
<input type="button" value="View Courier Details"  onclick="window.location.href='viewc.php' " />
</form>
